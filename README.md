...
Env overrides (mainly for testing): `GITMAP_SERVER`, `GITMAP_TOKEN`, `GITMAP_MAP` (skip repo→map resolution), `GITMAP_HOOK_DEBUG=1` (log to `~/.cache/gitmap/agent-hook.log`).
